...
A first-hand, on-device analysis of Anthropic's Fable 5 vs Opus 4.8 and Sonnet 5 — real usage
snapshots reconstructed from a Max 20× subscriber's own Claude Code logs.

**Live page:** enable GitHub Pages on this repo (Settings → Pages → Deploy from branch → `main` / root),
then it'll serve at `https://<you>.github.io/<repo>/`.

## Get the app

- **[AI Agent Usage — free on the App Store](https://apps.apple.com/us/app/ai-agent-usage/id6770159263?mt=12)** (older build)
- **[AI Agent Usage — signed DMG](https://github.com/jziesing/ai-agent-usage-downloads/releases/tag/v1.3.1)** (latest build, with model value + usage burn)

## What's here

### My first take on using Fable by Athropic with a Claude Code Max subscription (20x) 
* Marketed as the most capable model out there very misleading 
